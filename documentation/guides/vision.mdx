...
<Tip>
**Choosing a model:** Use `kimi-k2.5` or `gemma-4-31b` for complex visual reasoning, math, and multi-image analysis. Use `gemma-4-26b-a4b` or `qwen35-9b` for fast, efficient image tasks. Use `mistral-31-24b` when you need quick responses for simpler image tasks.
</Tip>
