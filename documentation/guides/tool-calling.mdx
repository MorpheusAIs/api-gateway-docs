...
| Model | Best For |
|-------|----------|
| `deepseek-v4-pro` | Frontier reasoning + tool calling, 1M context for whole-repo agents |
| `glm-5.1` | Complex multi-step tool orchestration |
| `glm-5` | Complex multi-step tool orchestration |
| `kimi-k2.6` | Parallel tool calls, agent workflows, vision + tools |
| `kimi-k2.5` | Parallel tool calls, agent workflows |
| `MiniMax-M2.7` | Autonomous multi-tool agents, cost-efficient orchestration |
| `minimax-m2.5` | Autonomous multi-tool agents |
| `deepseek-v4-flash` | Fast frontier-tier tool use, 1M context at lower latency |
| `arcee-trinity-large-thinking` | Long-horizon agents, multi-turn tool calling |
