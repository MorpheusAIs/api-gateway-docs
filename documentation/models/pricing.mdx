...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#21</span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <code>kimi-k2.5</code>
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#24</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Reasoning"><span>🧠</span></Tooltip>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#27</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Reasoning"><span>🧠</span></Tooltip>
      <Tooltip tip="Vision"><span>👀</span></Tooltip>
    </span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#40</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Reasoning"><span>🧠</span></Tooltip>
      <Tooltip tip="Vision"><span>👀</span></Tooltip>
    </span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#92</span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#118</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Reasoning"><span>🧠</span></Tooltip>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#50</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Reasoning"><span>🧠</span></Tooltip>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#38</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Reasoning"><span>🧠</span></Tooltip>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#126</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#59</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Reasoning"><span>🧠</span></Tooltip>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#81</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Reasoning"><span>🧠</span></Tooltip>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#109</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#89</span>
      <span style={{fontSize: '0.75rem', background: '#eab308', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Medium</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#138</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#166</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
    </span>
  </div>
  <div style={{display: 'flex', gap: '32px', marginBottom: '8px'}}>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#187</span>
      <span style={{fontSize: '0.75rem', background: '#eab308', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Medium</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#290</span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#207</span>
      <span style={{fontSize: '0.75rem', background: '#eab308', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Medium</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
      <Tooltip tip="Vision"><span>👀</span></Tooltip>
    </span>
