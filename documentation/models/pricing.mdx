...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#97</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#77</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#60</span>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#103</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#127</span>
      <span style={{fontSize: '0.75rem', background: '#16a34a', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Large</span>
    </span>
  </div>
  <div style={{display: 'flex', gap: '32px', marginBottom: '8px'}}>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#149</span>
      <span style={{fontSize: '0.75rem', background: '#eab308', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Medium</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#253</span>
      <span style={{fontSize: '0.75rem', background: '#3b82f6', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Small</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
...
<div style={{padding: '16px 0', borderBottom: '1px solid rgba(255,255,255,0.1)'}}>
  <div style={{display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px'}}>
    ...
    <span style={{marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '8px'}}>
      <span style={{fontSize: '0.75rem', opacity: '0.5', border: '1px solid var(--border)', padding: '2px 6px', borderRadius: '4px'}}>#170</span>
      <span style={{fontSize: '0.75rem', background: '#eab308', color: 'white', padding: '2px 8px', borderRadius: '4px'}}>Medium</span>
      <Tooltip tip="Function Calling"><span>⚡</span></Tooltip>
    </span>
  </div>
