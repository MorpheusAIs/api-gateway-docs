...
**Supported models:** `glm-5`, `kimi-k2.5`, `kimi-k2-thinking`, `glm-4.7-thinking`, `glm-4.7-flash`, `glm-4.7`, `minimax-m2.5`, `arcee-trinity-large-thinking`, `gemma-4-26b-a4b`, `gemma-4-31b`
</Accordion>

<Accordion title="Vision">
Vision-capable models can analyze images passed in the messages array.

**Supported models:** `mistral-31-24b`, `kimi-k2.5`, `gemma-4-26b-a4b`, `gemma-4-31b`, `qwen35-35b-a3b`, `qwen35-9b`
</Accordion>
...
**Supported models:** `qwen3-coder-480b-a35b-instruct`, `kimi-k2-thinking`, `glm-5`, `minimax-m2.5`, `arcee-trinity-large-thinking`
</Accordion>
</AccordionGroup>
