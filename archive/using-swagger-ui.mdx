...
The purpose of this document is to provide instructions for how to use the Morpheus API Gateway via the "Swagger UI". We recommend using the API Playground within the [API Reference Tab](https://apidocs.mor.org/api-reference/introduction), but recognize that this may be required for some purposes.
