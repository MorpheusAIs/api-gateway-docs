...
description: "How to integrate Morpheus API Gateway with Cursor IDE"
---
...
<Tip>
You're now ready to use Morpheus AI within Cursor! Start coding with AI-powered assistance from the Morpheus Compute Marketplace.
</Tip>
