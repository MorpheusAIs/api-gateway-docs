...
const response = await fetch(
  'https://api.mor.org/api/v1/session/pingsession',
  {
    method: 'POST',
    headers: {
...
<ResponseExample>
```json 200 Response - Session Alive
{
  "status": "alive",
  "session_id": "0xabcdef1234567890",
  "response_time_ms": 245,
  "message": "Session is active and responding"
}
```

```json 200 Response - Session Dead
{
  "status": "dead",
  "session_id": "0xabcdef1234567890",
  "message": "Session failed ping test and has been closed"
}
```

```json 200 Response - No Session
{
  "status": "no_session",
  "message": "No active session associated with this API key"
}
```
</ResponseExample>
