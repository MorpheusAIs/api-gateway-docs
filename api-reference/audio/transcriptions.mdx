...
<Warning>
**Playground limitation**: The interactive API playground does not correctly handle file uploads. Use the cURL examples below or an SDK instead. For testing in the playground, use the `s3_presigned_url` parameter as an alternative.
</Warning>
...
<ParamField body="file" type="file" format="binary">
